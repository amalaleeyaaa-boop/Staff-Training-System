...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $staff_no    = mysqli_real_escape_string($conn, trim($_POST['staff_no']));
    ...
    if (mysqli_query($conn, $sql)) {
        header("Location: view_staff.php?success=updated");
        exit;
    } else {
...
<head>
    ...
    <title>Edit Staff | Management System</title>
...
<div class="top-bar">
    <h1><i class="fa fa-user-edit"></i> Update Staff Information</h1>
    <div>
...
<div class="form-container">
    ...
    <form method="post">
        ...
        <input type="text" name="staff_no" value="<?php echo htmlspecialchars($staff['staff_id']); ?>" required>

        <label>Email Address *</label>
        <input type="email" name="email" value="<?php echo htmlspecialchars($staff['email']); ?>" required>

        <label>Phone Number</label>
        <input type="text" name="phone" value="<?php echo htmlspecialchars($staff['phone']); ?>" placeholder="012-3456789">
        ...
        <select name="role" required>
            <option value="staff" <?php if(strtolower($staff['role']) == 'staff') echo 'selected'; ?>>Regular Staff</option>
            <option value="admin" <?php if(strtolower($staff['role']) == 'admin') echo 'selected'; ?>>System Administrator</option>
        </select>
